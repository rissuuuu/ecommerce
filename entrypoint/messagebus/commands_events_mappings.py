from user_components.user.domain.command import (ActivateUser, AddUser,
                                                 ChangePassword,
                                                 ForgetPassword,
...
from user_components.user.service_layer.handlers import (
    activate_user, add_user, change_password, forget_password,
    forget_password_update, login_user, resend_otp, send_otp_to_user)
